...
contract EasyAvatarsSVG {
    // ATTRIBUTES START
    string[19] public skinToneNames = ['Pale Ivory', 'Warm Ivory', 'Sand','Rose Beige','Limestone','Beige','Sienna','Amber',
    ...
    string[16] public eyeColorNames = ['Black', 
    ...
    string[10] public glassesNames = ['None', 'Rectangular Glasses', 'Round Glasses', 'Sun Glasses', 'Futuristic Glasses', 'Eye Patch', 'Steampunk Glasses', '3D Glasses', 'VR Headset', 'EasyBlock Glasses'];
    ...
    string[8] public mouthNames = ['Normal', 'Smile', 'Unhappy', 'Ooo', 'Moustache', 'Fancy Moustache', 'Zombie', 'Vampire'];
