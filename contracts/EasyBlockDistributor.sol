...
contract EasyBlockDistributor {
    ...
    function distribute(
        ...
        // Access the contract
        Easyblock _easyContract = Easyblock(easyBlockContract);
        // Total share count
        uint256 _totalShareCount = _easyContract.totalShareCount();
        // Reward per share
        uint256 _rewardPerShare = _rewardAmount / _totalShareCount;
